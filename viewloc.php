...
$sql2 = "SELECT * FROM images WHERE id = 39 ";
...
<body>
    <div class="container">
        ...
        <!-- <div id="map"></div> -->
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3627.6728593026237!2d80.82963807443659!3d24.60048385561287!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39847fd8fae38d13%3A0x7569d2b86c00dc90!2sVindhya%20institute%20of%20technology%20science%20satna!5e0!3m2!1sen!2sin!4v1697774376799!5m2!1sen!2sin" width="100%" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        <?php
...
<div class="alert">
  ...
  <div class="fields fields--2">
    ...
    <label class="field">
      ...
      <input class="field__input" type="text" name="name" id="firstname" value="<?php echo $row1['number']; ?>"
        placeholder=" name" />
    </label>
  </div>
  <?php
